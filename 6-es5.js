...
/* harmony import */ var _themeStyle_1eba4ba6_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./themeStyle-1eba4ba6.js */ "./node_modules/corporate-ui/dist/esm-es5/themeStyle-1eba4ba6.js");
...
/* harmony import */ var _popper_3af5edbd_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./popper-3af5edbd.js */ "./node_modules/corporate-ui/dist/esm-es5/popper-3af5edbd.js");
...
var Dropdown = /** @class */ (function () {
    ...
    Dropdown.prototype.toggle = function () {
        ...
        var isActive = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(this._menu).hasClass(ClassName.SHOW);
        ...
        var showEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"].Event(Event.SHOW, relatedTarget);
    ...
    Dropdown.prototype.hide = function () {
        ...
        var hideEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"].Event(Event.HIDE, relatedTarget);
        var parent = Dropdown._getParentFromElement(this._element);
    ...
    Dropdown.prototype._addEventListeners = function () {
        var _this = this;
        Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(this._element).on(Event.CLICK, function (event) {
    ...
    Dropdown.prototype._getConfig = function (config) {
        config = __assign(__assign(__assign({}, this.constructor.Default), Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(this._element).data()), config);
        _util_75cdeb64_js__WEBPACK_IMPORTED_MODULE_4__["U"].typeCheckConfig(NAME, config, this.constructor.DefaultType);
        return config;
    };
    ...
    Dropdown.prototype._getPlacement = function () {
        var $parentDropdown = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(this._element.parentNode);
    ...
    Dropdown.prototype._getOffset = function () {
        ...
        if (typeof this._config.offset === 'function') {
            offset.fn = function (data) {
                data.offsets = __assign(__assign({}, data.offsets), _this._config.offset(data.offsets, _this._element) || {});
                return data;
            };
        }
        else {
    ...
    Dropdown._clearMenus = function (event) {
        ...
        for (var i = 0, len = toggles.length; i < len; i++) {
            ...
            var context = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(toggles[i]).data(DATA_KEY);
            var relatedTarget = {
    ...
    Dropdown._getParentFromElement = function (element) {
        var parent;
        var selector = _util_75cdeb64_js__WEBPACK_IMPORTED_MODULE_4__["U"].getSelectorFromElement(element);
        if (selector) {
    ...
    Dropdown._dataApiKeydownHandler = function (event) {
        ...
        var isActive = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_3__["default"])(parent).hasClass(ClassName.SHOW);
...
var Dropdown$1 = /** @class */ (function () {
    function Dropdown$1(hostRef) {
    ...
    Dropdown$1.prototype.handleClick = function (ev) {
        var target = ev ? ev.composedPath()[0] : window.event.target[0];
        if (this.node === target || target.getAttribute('slot') === 'dropdown-title') {
            var status = this.el.classList.contains('active') ? 'active' : 'inactive';
            this.toggle(status);
        }
        else {
            this.toggle('active');
    ...
    Dropdown$1.prototype.setTheme = function (name) {
        if (name === void 0) { name = undefined; }
        this.theme = name || this.store.getState().theme.current;
        this.currentTheme = this.store.getState().theme.items[this.theme];
    };
    Dropdown$1.prototype.toggle = function (status) {
        if (status === 'active') {
            this.dropdown.hide();
    ...
    Dropdown$1.prototype.componentWillLoad = function () {
        var _this = this;
        this.store = this.ContextStore || window.CorporateUi.store;
        this.setTheme(this.theme);
        this.store.subscribe(function () {
            _this.setTheme();
            Object(_themeStyle_1eba4ba6_js__WEBPACK_IMPORTED_MODULE_2__["t"])(_this.currentTheme, _this.tagName, _this.style, _this.el);
        });
        if (!(this.el && this.el.nodeName))
            return;
        this.tagName = this.el.nodeName.toLowerCase();
    };
    Dropdown$1.prototype.componentDidLoad = function () {
    ...
    Dropdown$1.prototype.render = function () {
        var _this = this;
        return (Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "\n          dropdown\n          " + (this.direction ? this.direction : '') + "\n        " }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: "btn btn-" + this.buttonType + " dropdown-toggle", type: "button", id: "dropdownMenuButton", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onClick: function (ev) { return _this.handleClick(ev); }, ref: function (node) { return _this.node = node; } }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "dropdown-title", "data-toggle": "dropdown" })), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "\n            dropdown-menu\n            " + (this.menuAlignment ? this.menuAlignment : '') + "\n          " }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "dropdown-item" })))));
    };
    Object.defineProperty(Dropdown$1.prototype, "el", {
        get: function () { return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Dropdown$1, "watchers", {
        get: function () {
            return {
                "theme": ["setTheme"]
            };
    ...
    Object.defineProperty(Dropdown$1, "style", {
