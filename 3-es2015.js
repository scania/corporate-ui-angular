...
const JQUERY_NO_CONFLICT = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].fn[NAME];
...
class Tab {
  ...
  show() {
    ...
    let target;
    let previous;
    const listElement = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(this._element).closest(Selector.NAV_LIST_GROUP)[0];
    const selector = _util_75cdeb64_js__WEBPACK_IMPORTED_MODULE_5__["U"].getSelectorFromElement(this._element);
    ...
    const hideEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].Event(Event.HIDE, {
      relatedTarget: this._element
    });

    const showEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].Event(Event.SHOW, {
    ...
    const complete = () => {
      const hiddenEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].Event(Event.HIDDEN, {
        relatedTarget: this._element
      });

      const shownEvent = _jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].Event(Event.SHOWN, {
        relatedTarget: previous
      });

      Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(previous).trigger(hiddenEvent);
      Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(this._element).trigger(shownEvent);
    };
  ...
  _activate(element, container, callback) {
    ...
    const isTransitioning = callback && (active && Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(active).hasClass(ClassName.FADE));
    ...
    if (active && isTransitioning) {
      const transitionDuration = _util_75cdeb64_js__WEBPACK_IMPORTED_MODULE_5__["U"].getTransitionDurationFromElement(active);
  ...
  _transitionComplete(element, active, callback) {
    if (active) {
      ...
      const dropdownChild = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(active.parentNode).find(
    ...
    if (element.parentNode && Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(element.parentNode).hasClass(ClassName.DROPDOWN_MENU)) {
      const dropdownElement = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(element).closest(Selector.DROPDOWN)[0];
  ...
  static _jQueryInterface(config) {
    return this.each(function () {
      const $this = Object(_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"])(this);
...
_jquery_2579d7a8_js__WEBPACK_IMPORTED_MODULE_4__["default"].fn[NAME].noConflict = () => {
...
const Cookie = class {
    ...
    async loadLibs() {
        const jsCookie = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./js.cookie-12a0f941.js */ "./node_modules/corporate-ui/dist/esm/js.cookie-12a0f941.js"));
    ...
    render() {
        return [
            Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("form", { onSubmit: event => this.save(event), onReset: (event) => { event.preventDefault(); this.open = false; } }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "config" }), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-modal", { open: this.open, config: this.modalConfig, close: false, class: this.inline ? 'inline' : '' }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h2", { slot: "header" }, this.headline), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("main", null, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row h-100 flex-sm-fill" + (this.active ? ' active' : '') }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-6 col-lg-3 h-100 navigation" }, this.introHeadline || this.introText ?
                ...
                : '', Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("nav", { class: "list-group", id: "v-pills-tab", role: "tablist", "aria-orientation": "vertical" }, this.items.map((item, index) => (Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { href: '#v-pills-' + index, class: 'list-group-item list-group-item-action' + (index === 0 ? ' active' : ''), "data-toggle": "pill", ref: el => this.tab = el, onClick: () => this.active = true }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-icon", { name: 'scania-angle-down', class: "d-lg-none" }), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "ml-3 mr-auto" }, item.text), item.toggable ?
                item.attributes.disabled ?
                    Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "checkbox", name: item.type || item.id, checked: this.items[index].attributes.checked, value: "true", hidden: true })
                    :
                        Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "custom-control custom-switch", onClick: event => event.stopPropagation() }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", Object.assign({ type: "checkbox", name: item.type || item.id, id: item.type || item.id, value: "true", class: "custom-control-input d-none", onChange: () => this.check(item, index) }, Object.assign({}, item.attributes))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("label", Object.assign({ class: "custom-control-label" }, { for: item.type || item.id })))
                : ''))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "link" }))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-6 col-lg-9 content" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "tab-content" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { href: "", class: "d-lg-none mb-5 btn-back", onClick: (event) => { event.preventDefault(); this.active = false; } }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-icon", { name: 'scania-angle-down' }), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "ml-2" }, this.headline)), this.items.map((item, index) => (Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'tab-pane fade' + (index === 0 ? ' show active' : ''), id: 'v-pills-' + index, role: "tabpanel", "aria-labelledby": 'v-pills-' + index + '-tab' }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", null, item.text), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("article", { innerHTML: item.content }), !item.attributes.disabled ?
                Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "custom-control custom-switch d-lg-none", onClick: event => event.stopPropagation() }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", Object.assign({ type: "checkbox", name: item.type || item.id, id: item.type || item.id, value: "true", class: "custom-control-input", onInput: () => this.check(item, index) }, Object.assign({}, item.attributes))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("label", Object.assign({ class: "custom-control-label" }, { for: item.type || item.id })))
                : Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "badge badge-pill badge-primary" }, item.attributes.checked ? this.activeText : '')))))))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "reset", class: "btn btn-secondary", slot: "footer" }, this.modalButtonSecondary), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "submit", class: "btn btn-primary", slot: "footer" }, this.modalButtonPrimary))),
            !this.cookie ?
                Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("footer", { class: this.inline ? 'inline' : '' }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "container" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col main" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "main" })), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-sm-12 col-lg-auto mt-4 mb-4 btn-container" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col col-lg-auto" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: "btn btn-block btn-outline-light", onClick: () => this.open = true }, this.mainButtonSecondary)), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col col-lg-auto" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: "btn btn-block btn-outline-light", onClick: event => { this.all = true; this.save(event); } }, this.mainButtonPrimary)))))))
                :
...
/***/ "./node_modules/corporate-ui/dist/esm/js.cookie-12a0f941.js":
/*!******************************************************************!*\
  !*** ./node_modules/corporate-ui/dist/esm/js.cookie-12a0f941.js ***!
  \******************************************************************/
...
/* harmony import */ var _commonjsHelpers_97e6d7b1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_commonjsHelpers-97e6d7b1.js */ "./node_modules/corporate-ui/dist/esm/_commonjsHelpers-97e6d7b1.js");
