...
var TableComponent = /** @class */ (function () {
    ...
    TableComponent.prototype.onChangeContent = function () {
        this.filterContent();
    };
    TableComponent.prototype.setTheme = function (name) {
        if (name === void 0) { name = undefined; }
        this.theme = name || this.store.getState().theme.current;
        this.currentTheme = this.store.getState().theme.items[this.theme];
    };
    TableComponent.prototype.componentWillLoad = function () {
        var _this = this;
    ...
    TableComponent.prototype.filterContent = function () {
        ...
        var _loop_1 = function (key) {
            this_1.data.forEach(function (v) { delete v[key]; });
        };
        var this_1 = this;
    ...
    TableComponent.prototype.sortData = function (key, direction) {
        ...
        if (direction == "asc") {
            this.filteredData.sort(function (a, b) { return (a[key] > b[key]) ? 1 : -1; });
        }
        else {
            this.filteredData.sort(function (a, b) { return (a[key] < b[key]) ? 1 : -1; });
        }
        /* Disable other sort-active class and set the active the current selected */
        var actives = (this.el.shadowRoot || this.el).querySelectorAll(".sort-active");
    ...
    TableComponent.prototype.searchColumn = function () {
        var _this = this;
        /* Needs to reset the Prop to make the changes */
        this.filteredData = __spreadArrays(this.data);
        var keys = this.header.map(function (cl) { return cl.key; });
        ...
        var _loop_2 = function (key) {
            ...
            if (inputValue) {
                ...
                /* Filter the values */
                var columnFiltered_1 = column.filter(function (cl) { return _this.matchValue(cl, inputValue); });
                /* Values that should return */
                var arrayFiltered = items.filter(function (el) { return columnFiltered_1.includes(el[key]); });
                items = [];
                for (var _i = 0, arrayFiltered_1 = arrayFiltered; _i < arrayFiltered_1.length; _i++) {
                    var item = arrayFiltered_1[_i];
                    items.push(item);
                }
            }
        };
    ...
    TableComponent.prototype.matchValue = function (data, value) {
        if (data) {
            return Object.keys(data).map(function () {
                return new RegExp(value, 'gi').test(data);
            }).some(function (result) { return result; });
        }
    };
    /* Sets the header of the table */
    TableComponent.prototype.setHeader = function () {
        var _this = this;
        return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, (this.header.map(function (a) { return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", null, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "table-title" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, a.description), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { onClick: function () { return _this.sortData(a.key, "desc"); } }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-icon", { class: "sort-desc", id: "desc" + a.key, name: "scania-angle-down" })), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { onClick: function () { return _this.sortData(a.key, "asc"); } }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-icon", { class: "sort-asc", id: "asc" + a.key, name: "scania-angle-down" })))), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "input-field" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { id: "search" + a.key, onKeyUp: function () { return _this.searchColumn(); }, type: "text", class: "form-control" }), Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: "icon" + a.key, class: "input-icon-filter" }))); })), this.hasEdit || this.hasDelete
            ? Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("th", null)
            : null);
    };
    /* Sets the boby of the table */
    TableComponent.prototype.setbody = function () {
        var _this = this;
        var keys = this.header.map(function (a) { return a.key; });
        return (this.filteredData.map(function (obj) { return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("tr", null, keys.map(function (key) { return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", null, obj[key]); }), _this.setDropDown(obj.rowIndex)); }));
    };
    ...
    TableComponent.prototype.setDropDown = function (rowIndex) {
        var _this = this;
        if (this.hasEdit || this.hasDelete)
            return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("td", { class: "text-right" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("c-dropdown", { buttonType: "primary", menuAlignment: "dropdown-menu-right" }, Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { slot: "dropdown-title" }, "Action"), this.hasEdit && Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { slot: "dropdown-item", class: "dropdown-item", onClick: function () { return _this.callbackDropdown("edit", rowIndex); } }, "Edit"), this.hasDelete && Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { slot: "dropdown-item", class: "dropdown-item text-danger", onClick: function () { return _this.callbackDropdown("delete", rowIndex); } }, "Delete")));
    };
    /* Makes the callback for the developer */
    TableComponent.prototype.callbackDropdown = function (event, rowIndex) {
        var obj = this.content[rowIndex];
        if (event === "edit")
    ...
    Object.defineProperty(TableComponent.prototype, "el", {
        get: function () { return Object(_core_dafe424f_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TableComponent, "watchers", {
        get: function () {
            return {
